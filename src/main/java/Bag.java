...
public abstract class Bag {
    ...
    public boolean addItem(String item) {
        if (this.numberOfContents < this.capacity) {
            ...
            // what this does is since capacity is bigger than number of contents means we have empty
            // space ,and it adds it where there is the first empty space
    ...
    public void increaseCapacity(int n) {
        this.capacity += n;
        String[] newLists = new String[capacity];
        for (int i = 0; i < this.numberOfContents; i++) {
            newLists[i] = this.contents[i];
        }
        this.contents = newLists;
    }
